...
- [ ] 11.5 Locally smoke-test the workflow with `act` or a draft PR — confirm the run summary surfaces WARNING/INFO notices without failing _(deferred to PR review — the CI run on this PR is the smoke test)_
